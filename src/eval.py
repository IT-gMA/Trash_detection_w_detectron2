...
from train import AugTrainer


# This is probably to perform evaluation using the test datatset instead of the valid dataset
def evaluate_model(after_train=False, cfg=None, predictor=None, eval_dataset_name=None):
    ...
    eval_loader = AugTrainer.build_test_loader(cfg, eval_dataset_name)
